...
function SignIn() {
    ...
    const handleInputChange = (field, value) => {
        setErrors((prev) => ({ ...prev, [field]: "" })); // Remove error when user starts typing
    ...
    const signIn = async (e) => {
        ...
        try {
            const { data } = await axios.post("http://localhost:3000/student/student-signInn", { email, password });
    ...
    const handleGoogleSuccess = async (response) => {
        ...
        try {
            const { data } = await axios.post("http://localhost:3000/student/student-signInn", { email: googleEmail, password: googlePassword });
            ...
            <div className="container">
                <div className="form">
                    <form onSubmit={signIn}>
                        ...
                        <Link className="btn btn-block text-dark mt-4" id="minibtn" to={"/student-signUp"}>
